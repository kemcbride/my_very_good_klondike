...
e2e_test ./bazel-out/k8-fastbuild-clang-opt/bin/solitaire opt $OPT_TIMEOUT_LIMIT 10 inputs/10.txt
...
e2e_test ./bazel-out/k8-dbg-clang-dbg/bin/solitaire dbg $DBG_TIMEOUT_LIMIT 10 inputs/10.txt
